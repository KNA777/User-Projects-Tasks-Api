...
- в связи со спешкой выполнения тестового задания, есть определенное кол-во необработанных кейсов(в плане ошибок)
...
5. Чтобы проверить работу sse создайте задачу для проетка и введите id того пользователя, который ввел свой access_token на тестовой странице,
